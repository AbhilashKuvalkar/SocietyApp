        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocietyCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Particulars_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receipts_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceiptLineItems_Particulars_ParticularId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Particulars_SocietyId",
                table: "Particulars",
                column: "SocietyId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceiptLineItems_ParticularId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receipts_SocietyId",
                table: "Receipts",
                column: "SocietyId");

            migrationBuilder.CreateIndex(
                name: "IX_Societies_SocietyCode",
                table: "Societies",
                column: "SocietyCode",
                unique: true);
        }
